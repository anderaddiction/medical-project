...
return [
    ...
    "States" => "Estados",
    "States_table" => "Tabla de Estados",
    "Municipalities" => "Municipios",
    "Municipalities_table" => "Tabla de Municipios",
    "Parishes" => "Parroquias",
    "Parishes_table" => "Tabla de Parroquias",
    "Cities_table" => "Tabla de Ciudades",
    "Cities" => "Ciudades",
    "Banks" => "Bancos",
    "Banks_table" => "Tabla de Bancos",
    "Entities" => "Entidades",
    ...
    "Codes" => "Códigos",
    "Telephone_table" => "Tabla de Códigos Teléfonicos",
    "Users" => "Usuarios",
    "Documents" => "Documentos",
    "Documents_table" => "Tabla de Documentos",
    "Currencies" => "Monedas del Mundo",
